...
const MarqueeAlongSvgPath = ({
    ...
    useEffect(() => {
        ...
        const updateScale = () => {
            ...
            // Center vertically, width is full (offsetX is 0)
            const offsetX = 0
    ...
    // Use stable ID that matches between SSR and client (avoids hydration mismatch)
    ...
    // Pause animation when scrolled out of view to free CPU for other sections
